    ...
    with wandb.init(config=config):
        ...
        for epoch in range(config.epochs):
            ...
            with torch.no_grad():
                ...
                hard_avg, hard_classes, soft_avg = evaluate_model(classifier, test_data_loader)
                wandb.log(hard_avg)
                wandb.log(soft_avg)
                ...
                # if the actual and the previous iteration test losses are worst than the best, early stopping is triggered
